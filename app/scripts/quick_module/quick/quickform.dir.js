...
(function(){
  ...
  var quickForm = function quickForm_($templateRequest, $compile, $interpolate, transcludeHelper) {
    ...
    function link(scope, element, attrs){
      $templateRequest('scripts/quick_module/quick/quickform.dir.html').then(
        function(html){
...
u
  ...
  var QuickFormController = function QuickFormController_ ($scope,
                                                           transcludeHelper,
                                                           sh,
                                                           quickFormHelper,
                                                           dialogService) {
    ...
    $scope.render = function render( utils ) {
      ...
      console.log('quickform', 'runder', dataObject, formObject )
