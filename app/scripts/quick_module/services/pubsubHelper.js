/**
 * Modifies angularpub sub to form object that is speerate
 */
(function (module) {
  'use strict';

  var pubSubHelper = function pubSubHelper($timeout) {
    ...
    var service = {};
    service = createPubSub();
    service.create = function () {
      return createPubSub();
    }
    return service;
  };
  pubSubHelper.$inject = ['$timeout'];
  angular.module('com.sync.quick').factory('pubSubHelper', pubSubHelper );
  angular.module('com.sync.quick').factory('pubSub', pubSubHelper );
}(angular.module));
