...
( function() {
  ...
  var quickChecklistHelperService = function quickChecklistHelperService( sh, pubSub ) {
    function QuickChecklistHelper() {
      var self = this;
      var p = this;
    ...
    var service = new QuickChecklistHelper();
    var qF = service;

    return qF;
  }

  quickChecklistHelperService.$inject = ['sh', 'pubSub'];

  angular.module('com.sync.quick').factory('quickChecklistHelper', quickChecklistHelperService );
  angular.module('com.sync.quick').factory('qFH', quickChecklistHelperService );
}());
